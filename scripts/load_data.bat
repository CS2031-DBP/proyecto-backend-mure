...
set sqlCommand2=\COPY song (id, title, title_normalized, genre, release_date, duration, cover_image, likes, times_played, album_id, link) FROM '../data/songs.csv' DELIMITER ',' CSV HEADER ENCODING 'utf-8';
