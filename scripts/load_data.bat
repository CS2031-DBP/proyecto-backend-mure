...
set songSqlCommand=\COPY song (title, title_normalized, genre, release_date, duration, cover_image, likes, times_played, album_id, link) FROM '../assets/data/songs.csv' DELIMITER ',' CSV HEADER ENCODING 'utf-8';
