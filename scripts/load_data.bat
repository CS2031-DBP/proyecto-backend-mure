...
set songSqlCommand=\COPY song (title, title_normalized, genre, genre_normalized, release_date, duration, cover_image_url, likes, times_played, album_id, spotify_url, spotify_preview_url) FROM '../assets/data/songs.csv' DELIMITER ',' CSV HEADER ENCODING 'utf-8';
