...
$sqlCommand2 = "\COPY song (id, title, title_normalized, genre, release_date, duration, cover_image, likes, times_played, album_id, link) FROM '../data/songs.csv' DELIMITER ',' CSV HEADER ENCODING 'utf-8';"
...
$sqlCommand4 = "\COPY artist_songs (artist_id, song_id) FROM '../data/artist_songs.csv' DELIMITER ',' CSV HEADER ENCODING 'utf-8';"
...
& psql -h localhost -p 5433 -U postgres -d database -c $sqlCommand4
